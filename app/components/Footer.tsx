...
const footerCategories: FooterCategory[] = [
  ...
  },
  {
    ...
    links: [
      { label: 'Luxury Brands', href: '/premium/luxury' },
      { label: 'Designer Wear', href: '/premium/designer' },
      { label: 'Limited Edition', href: '/premium/limited' },
    ],
  },
  {
    title: 'Support',
...
const Footer: FC = () => {
  ...
  return (
    <footer className="border-t border-gray-200 bg-gray-50 py-8 animate-fade-in">
      <div className="mx-auto max-w-7xl px-4">
        ...
        <div className="mt-8 border-t border-gray-200 pt-6">
          <p className="text-center text-xs text-gray-500">
            &copy; {currentYear} ELAM. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
